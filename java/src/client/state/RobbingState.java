...
public class RobbingState implements IStateBase {
	
	private Facade facade;
	private HexLocation newRobberHexLoc;
	...
	public void robPlayer(RobPlayerInfo victim) {
		this.facade.playSoldierCard(victim, newRobberHexLoc);
	}
