...
public class TradeOfferedWaitingState implements IStateBase {

	private Facade facade;
	
	public TradeOfferedWaitingState(Facade facade) {
		this.facade = facade;
	}
	...
	public void increaseAmount(ResourceType resource) {
		facade.increaseAmount(resource);
	}

	@Override
	public void decreaseAmount(ResourceType resource) {
		facade.decreaseAmount(resource);
	}
